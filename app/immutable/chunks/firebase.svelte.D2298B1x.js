import{p as jc}from"./proxy.pcUAtjrM.js";import{s as dp,g as fp,d as Qe,b as qc,f as zc,e as Kc}from"./runtime.DmOoDO8L.js";var Gc={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tm{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(nm(t)){const n=t.getImmediate();return`${n.library}/${n.version}`}else return null}).filter(t=>t).join(" ")}}function nm(r){const e=r.getComponent();return(e==null?void 0:e.type)==="VERSION"}const po="@firebase/app",Jc="0.10.9";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qm(r){bn(new Wt("platform-logger",e=>new tm(e),"PRIVATE")),bn(new Wt("heartbeat",e=>new Um(e),"PRIVATE")),Et(po,Jc,r),Et(po,Jc,"esm2017"),Et("fire-js","")}qm("");var zm="firebase",Km="10.13.0";/**
 * @license
