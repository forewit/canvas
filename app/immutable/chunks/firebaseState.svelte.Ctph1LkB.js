 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(r="Unexpected state"){const e=`FIRESTORE (${Yn}) INTERNAL ASSERTION FAILED: `+r;throw he(e),new Error(e)}function q(r,e){r||L()}function F(r,e){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xo extends qh{constructor(e,t){super(),this._e=e,this.currentSequenceNumber=t}}function me(r,e){const t=F(r);return Ct.F(t._e,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bd(r,e,t){const n=r.store("mutations"),i=r.store("documentMutations"),s=[],o=IDBKeyRange.only(t.batchId);let c=0;const u=n.J({range:o},(f,m,E)=>(c++,E.delete()));s.push(u.next(()=>{q(c===1)}));const h=[];for(const f of t.mutations){const m=$h(e,f.key.path,t.batchId);s.push(i.delete(m)),h.push(f.key)}return A.waitFor(s).next(()=>h)}function ss(r){if(!r)return 0;let e;if(r.document)e=r.document;else if(r.unknownDocument)e=r.unknownDocument;else{if(!r.noDocument)throw L();e=r.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gE{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.x_=[],this.O_=new Map,this.N_=new Set,this.L_=[],this.B_=s,this.B_.oo(o=>{n.enqueueAndForget(async()=>{fn(this)&&(C("RemoteStore","Restarting streams for network reachability change."),await async function(u){const h=F(u);h.N_.add(4),await ai(h),h.k_.set("Unknown"),h.N_.delete(4),await Ds(h)}(this))})}),this.k_=new mE(n,i)}}async function Ds(r){if(fn(r))for(const e of r.L_)await e(!0)}async function ai(r){for(const e of r.L_)await e(!1)}function Vs(r,e){const t=F(r);t.O_.has(e.targetId)||(t.O_.set(e.targetId,e),Na(t)?xa(t):er(t).n_()&&ka(t,e))}function jn(r,e){const t=F(r),n=er(t);t.O_.delete(e),n.n_()&&of(t,e),t.O_.size===0&&(n.n_()?n.s_():fn(t)&&t.k_.set("Unknown"))}function ka(r,e){if(r.q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(z.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}er(r).d_(e)}function of(r,e){r.q_.xe(e),er(r).A_(e)}function xa(r){r.q_=new pI({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>r.O_.get(e)||null,tt:()=>r.datastore.serializer.databaseId}),er(r).start(),r.k_.D_()}function Na(r){return fn(r)&&!er(r).t_()&&r.O_.size>0}function fn(r){return F(r).N_.size===0}function af(r){r.q_=void 0}async function _E(r){r.k_.set("Online")}async function yE(r){r.O_.forEach((e,t)=>{ka(r,e)})}async function IE(r,e){af(r),Na(r)?(r.k_.F_(e),xa(r)):r.k_.set("Unknown")}async function EE(r,e,t){if(r.k_.set("Online"),e instanceof wd&&e.state===2&&e.cause)try{await async function(i,s){const o=s.cause;for(const c of s.targetIds)i.O_.has(c)&&(await i.remoteSyncer.rejectListen(c,o),i.O_.delete(c),i.q_.removeTarget(c))}(r,e)}catch(n){C("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),n),await us(r,n)}else if(e instanceof ji?r.q_.Ke(e):e instanceof Td?r.q_.He(e):r.q_.We(e),!t.isEqual(z.min()))try{const n=await Yd(r.localStore);t.compareTo(n)>=0&&await function(s,o){const c=s.q_.rt(o);return c.targetChanges.forEach((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=s.O_.get(h);f&&s.O_.set(h,f.withResumeToken(u.resumeToken,o))}}),c.targetMismatches.forEach((u,h)=>{const f=s.O_.get(u);if(!f)return;s.O_.set(u,f.withResumeToken(de.EMPTY_BYTE_STRING,f.snapshotVersion)),of(s,u);const m=new ot(f.target,u,h,f.sequenceNumber);ka(s,m)}),s.remoteSyncer.applyRemoteEvent(c)}(r,t)}catch(n){C("RemoteStore","Failed to raise snapshot:",n),await us(r,n)}}async function us(r,e,t){if(!Lt(e))throw e;r.N_.add(1),await ai(r),r.k_.set("Offline"),t||(t=()=>Yd(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{C("RemoteStore","Retrying IndexedDB access"),await t(),r.N_.delete(1),await Ds(r)})}function cf(r,e){return e().catch(t=>us(r,t,e))}async function Zn(r){const e=F(r),t=Nt(e);let n=e.x_.length>0?e.x_[e.x_.length-1].batchId:-1;for(;vE(e);)try{const i=await aE(e.localStore,n);if(i===null){e.x_.length===0&&t.s_();break}n=i.batchId,TE(e,i)}catch(i){await us(e,i)}uf(e)&&lf(e)}function vE(r){return fn(r)&&r.x_.length<10}function TE(r,e){r.x_.push(e);const t=Nt(r);t.n_()&&t.R_&&t.V_(e.mutations)}function uf(r){return fn(r)&&!Nt(r).t_()&&r.x_.length>0}function lf(r){Nt(r).start()}async function wE(r){Nt(r).g_()}async function AE(r){const e=Nt(r);for(const t of r.x_)e.V_(t.mutations)}async function bE(r,e,t){const n=r.x_.shift(),i=Ta.from(n,e,t);await cf(r,()=>r.remoteSyncer.applySuccessfulWrite(i)),await Zn(r)}async function SE(r,e){e&&Nt(r).R_&&await async function(n,i){if(function(o){return hI(o)&&o!==P.ABORTED}(i.code)){const s=n.x_.shift();Nt(n).i_(),await cf(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,i)),await Zn(n)}}(r,e),uf(r)&&lf(r)}async function Tl(r,e){const t=F(r);t.asyncQueue.verifyOperationInProgress(),C("RemoteStore","RemoteStore received new credentials");const n=fn(t);t.N_.add(3),await ai(t),n&&t.k_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.N_.delete(3),await Ds(t)}async function Qo(r,e){const t=F(r);e?(t.N_.delete(2),await Ds(t)):e||(t.N_.add(2),await ai(t),t.k_.set("Unknown"))}function er(r){return r.Q_||(r.Q_=function(t,n,i){const s=F(t);return s.y_(),new dE(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(r.datastore,r.asyncQueue,{To:_E.bind(null,r),Ao:yE.bind(null,r),Vo:IE.bind(null,r),E_:EE.bind(null,r)}),r.L_.push(async e=>{e?(r.Q_.i_(),Na(r)?xa(r):r.k_.set("Unknown")):(await r.Q_.stop(),af(r))})),r.Q_}function Nt(r){return r.K_||(r.K_=function(t,n,i){const s=F(t);return s.y_(),new fE(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(r.datastore,r.asyncQueue,{To:()=>Promise.resolve(),Ao:wE.bind(null,r),Vo:SE.bind(null,r),m_:AE.bind(null,r),f_:bE.bind(null,r)}),r.L_.push(async e=>{e?(r.K_.i_(),await Zn(r)):(await r.K_.stop(),r.x_.length>0&&(C("RemoteStore",`Stopping write stream with ${r.x_.length} pending writes`),r.x_=[]))})),r.K_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
